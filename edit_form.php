 ...
 * @author     Johan Reinalda <johan at reinalda dot net>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

class block_announcements_tbird_edit_form extends block_edit_form {
    protected function specific_definition($mform) {
    	...
    	if(!empty($allowcustom) and $allowcustom) {
	        $mform->addElement('header', 'configheader', get_string('announcements_tbird_settings', 'block_announcements_tbird'));

    	    $editoroptions = array('maxfiles' => EDITOR_UNLIMITED_FILES, 'noclean'=>true, 'context'=>$this->block->context);
        	$mform->addElement('editor', 'config_text', get_string('configadditionalcontent', 'block_announcements_tbird'), null, $editoroptions);
